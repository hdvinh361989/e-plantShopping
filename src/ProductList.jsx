...
import CartSliceReducer, {addItem, CartSlice} from "./CartSlice.jsx";
...
function ProductList() {
    ...
    const categoryTemplates = plantsArray.map(({category, plants}) => {
        const itemTemplates = plants.map(({name, cost, description, image}) => {
            return (
                <div key={name} className="product-card">
                    ...
                    <p>{description}</p>
                    <button type="button"
                            className={`product-button ${addedToCartNames.includes(name) ? 'added-to-cart ' : ''}`}
                            disabled={addedToCartNames.includes(name)}
                            onClick={() => addToCart({name, cost, description, image})}>Add to Cart
                    </button>
                </div>
            )
        })
        return (
            <>
                <div className="product-category ">
                    <h2 className="category-name plant_heading">{category}</h2>
                </div>
    ...
    return (
        <div>
            <div className="navbar">
                ...
                {/*Menu*/}
                <div className="menu">
                    <div className=""><a href="#" className="menu-item" onClick={(e) => handlePlantsClick(e)}>Plants</a></div>
                    <div><a href="#" className="menu-item" onClick={(e) => handleCartClick(e)}>
                        <h1 className='cart'>
